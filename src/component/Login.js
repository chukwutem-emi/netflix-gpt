  ...
  return (
    <div>
        ...
        <form className='w-[30rem] my-40 mx-auto shadow-lg p-8 bg-black bg-opacity-80 absolute z-40'>
            ...
            {!isSignInForm && (<input type= "text"  placeholder="Full Name" className="p-4 outline-none w-[100%] bg-gray-700 rounded-lg mb-[1.5rem]" autoComplete='on' autoFocus/>)}
            <input type= "email"  placeholder="email address" className="p-4 outline-none w-[100%] bg-gray-700 rounded-lg mb-[1.5rem]" autoComplete='on' autoFocus/>
            <input type= "password"  placeholder="password" className="p-4 outline-none w-[100%] bg-gray-700 rounded-lg mb-[1.5rem]"/>
